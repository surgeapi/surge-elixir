defmodule Surge.Accounts do
  ...
  ## Examples
      ...
      Surge.Accounts.create(%{name: "Test Account"})
      #=> {:ok, %Surge.Accounts.Account{}}

      client = Surge.Client.new("your_api_key")
      Surge.Accounts.create(client, %{name: "Test Account"})
      #=> {:ok, %Surge.Accounts.Account{}}
  ...
  ## Examples
      ...
      Surge.Accounts.get_status("acct_123", [:local_messaging])
      #=> {:ok, %Surge.Accounts.AccountStatus{capabilities: %{local_messaging: %{status: :ready}}}}

      client = Surge.Client.new("your_api_key")
      Surge.Accounts.get_status(client, "acct_123", [:local_messaging])
      #=> {:ok, %Surge.Accounts.AccountStatus{capabilities: %{local_messaging: %{status: :ready}}}}
  ...
  def get_status(%Client{} = client, account_id, capabilities) do
    params = %{"capabilities" => Enum.join(capabilities, ",")}
  ...
  ## Examples
      ...
      Surge.Accounts.update("acct_123", %{name: "Updated Account"})
      #=> {:ok, %Surge.Accounts.Account{name: "Updated Account"}}

      client = Surge.Client.new("your_api_key")
      Surge.Accounts.update(client, "acct_123", %{name: "Updated"})
      #=> {:ok, %Surge.Accounts.Account{}}
