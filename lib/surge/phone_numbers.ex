defmodule Surge.PhoneNumbers do
  ...
  ## Examples
      ...
      Surge.PhoneNumbers.purchase("acct_123", %{type: :toll_free})
      #=> {:ok, %Surge.PhoneNumbers.PhoneNumber{}}

      # Purchase with area code search
      Surge.PhoneNumbers.purchase("acct_123", %{type: :local, area_code: "415"})
      #=> {:ok, %Surge.PhoneNumbers.PhoneNumber{}}

      client = Surge.Client.new("your_api_key")
      Surge.PhoneNumbers.purchase(client, "acct_123", %{area_code: "212", type: :local})
      #=> {:ok, %Surge.PhoneNumbers.PhoneNumber{}}
