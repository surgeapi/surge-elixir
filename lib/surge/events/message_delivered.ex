defmodule Surge.Events.MessageDelivered do
  @moduledoc """
  ...
  * Log customer interactions
  ...
  @doc """
  Converts JSON webhook payload to MessageDelivered struct.
  ...
  ## Examples
      ...
      ...>   }
      ...> }
      iex> Surge.Events.MessageDelivered.from_json(data)
      %Surge.Events.MessageDelivered{
        id: "msg_01jjnn7s0zfx5tdcsxjfy93et2",
        body: "Dude, I almost had you!",
        attachments: [
