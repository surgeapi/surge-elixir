defmodule Surge.Users do
  ...
  ## Examples
      ...
      iex> Surge.Users.create_token("usr_123", %{duration_seconds: 3600})
      {:ok, "eyJ..."}

      iex> client = Surge.Client.new("your_api_key")
      iex> Surge.Users.create_token(client, "usr_123", %{})
      {:ok, "eyJ..."}
  ...
  ## Examples
      ...
      iex> Surge.Users.get("usr_123")
      {:ok, %Surge.Users.User{id: "usr_123", ...}}

      iex> client = Surge.Client.new("your_api_key")
      iex> Surge.Users.get(client, "usr_123")
      {:ok, %Surge.Users.User{}}
  ...
  ## Examples
      ...
      iex> Surge.Users.update("usr_123", %{first_name: "Jane"})
      {:ok, %Surge.Users.User{id: "usr_123", first_name: "Jane"}}

      iex> client = Surge.Client.new("your_api_key")
      iex> Surge.Users.update(client, "usr_123", %{first_name: "Sally"})
