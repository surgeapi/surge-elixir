defmodule Surge.Verifications do
  ...
  ## Examples
      ...
      Surge.Verifications.create(%{phone_number: "+18015551234"})
      #=> {:ok, %Surge.Verifications.Verification{id: "vfn_123"}}

      client = Surge.Client.new("your_api_key")
      Surge.Verifications.create(client, %{to: "+18015551234"})
  ...
  ## Examples
      ...
      Surge.Verifications.check("vfn_123", %{code: "123456"})
      #=> {:ok, %Surge.Verifications.VerificationCheck{result: :ok}}

      client = Surge.Client.new("your_api_key")
      Surge.Verifications.check(client, "verification_123", %{code: "000000"})
